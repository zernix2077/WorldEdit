...
/**
 * Replaces outer faces of current selection.
 */
public final class FacesCommand extends RegionCommand {
    public FacesCommand() {
        super("faces", "worldedit:command.faces.description", List.of("outline"));
    }
        ...
        tree.getRoot()
                ...
                .exec((context, player) -> {
                    ...
                    return runWithSnapshot(context, player, snapshot -> {
                        ...
                        player.sendTranslatable(RegionMessages.FACES_SUCCESS, total);
                    });
